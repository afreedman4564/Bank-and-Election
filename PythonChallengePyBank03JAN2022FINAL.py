...
# import statistics to calculate mean of prof/loss change from month to month
import statistics
...
with open(csvpath) as csvfile:
    ...
    # calculate the mean of the profit/loss month over month change using the list without inserted value. Don't want to count the 0 for first month over month calculation
